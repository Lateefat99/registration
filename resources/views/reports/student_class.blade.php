        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
            <div class="shadow overflow-hidden sm:rounded-md">
                <div class="px-3 py-3 bg-white sm:p-3">
                    <form action="{{route('report.create')}}" method="GET">
                        @csrf
                        <div class="grid grid-cols-6 gap-3">
                            ...
                            <div class="col-span-6 sm:col-span-1">
                                ...
                                <select id="studentClass" name="studentClass" autocomplete="studentClass"
                                        class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md
                                        shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500
                                        sm:text-sm">
                                    <option value=""></option>
                                ...
                                <span style="color: red"> @error('studentClass'){{$message}}@enderror</span>
                            </div>
